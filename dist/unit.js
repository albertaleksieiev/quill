...
var scroll_1 = __webpack_require__(71);
var inline_1 = __webpack_require__(72);
var block_1 = __webpack_require__(73);
var embed_1 = __webpack_require__(74);
...
var BlockEmbed = function (_Parchment$Embed) {
  ...
  _createClass(BlockEmbed, [{
    ...
    value: function format(name, value) {
      var attribute = this.scroll.query(name, _parchment2.default.Scope.BLOCK_ATTRIBUTE);
      if (attribute != null) {
...
var Block = function (_Parchment$Block) {
  ...
  function Block(scroll, domNode) {
    ...
    var _this2 = _possibleConstructorReturn(this, (Block.__proto__ || Object.getPrototypeOf(Block)).call(this, scroll, domNode));
  ...
  _createClass(Block, [{
    ...
    value: function formatAt(index, length, name, value) {
      if (length <= 0) return;
      if (this.scroll.query(name, _parchment2.default.Scope.BLOCK)) {
...
var globalRegistry = new _parchment2.default.Registry();
...
var Quill = function () {
  ...
  function Quill(container) {
    ...
    var ScrollBlot = this.options.registry.query(_parchment2.default.Scroll.blotName);
  ...
  _createClass(Quill, [{
    ...
    value: function format(name, value) {
      ...
      return modify.call(this, function () {
        ...
        if (range == null) {
          return change;
        } else if (_this4.scroll.query(name, _parchment2.default.Scope.BLOCK)) {
...
var Inline = function (_Parchment$Inline) {
  ...
  _createClass(Inline, [{
    key: 'formatAt',
    value: function formatAt(index, length, name, value) {
      if (Inline.compare(this.statics.blotName, name) < 0 && this.scroll.query(name, _parchment2.default.Scope.BLOT)) {
...
var CodeBlock = function (_Block) {
  ...
  _createClass(CodeBlock, [{
    ...
    value: function formatAt(index, length, name, value) {
      if (length === 0) return;
      if (this.scroll.query(name, _parchment2.default.Scope.BLOCK) == null || name === this.statics.blotName && value === this.statics.formats(this.domNode)) {
        return;
      }
    ...
    value: function replace(target) {
      ...
      [].slice.call(this.domNode.querySelectorAll('*')).forEach(function (node) {
        var blot = _this4.scroll.find(node);
        if (blot == null) {
...
function normalizeDelta(delta, scroll) {
  return delta.reduce(function (delta, op) {
    ...
    if (typeof op.insert === 'string') {
      ...
      var insertDelta = normalizeInsert(text, op.attributes, scroll);
...
function normalizeInsert(text, attributes, scroll) {
  ...
  var blockAttributes = {};
  Object.keys(attributes).forEach(function (name) {
    if (scroll.query(name, _parchment2.default.Scope.INLINE) != null) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var linked_list_1 = __webpack_require__(70);
...
var Scroll = function (_Parchment$Scroll) {
  ...
  _createClass(Scroll, [{
    ...
    value: function insertAt(index, value, def) {
      if (index >= this.length()) {
        if (def == null || this.scroll.query(value, _parchment2.default.Scope.BLOCK) == null) {
          var blot = this.scroll.create(this.statics.defaultChild);
          this.appendChild(blot);
    ...
    value: function insertBefore(blot, ref) {
      if (blot.statics.scope === _parchment2.default.Scope.INLINE_BLOT) {
        var wrapper = this.scroll.create(this.statics.defaultChild);
...
function applyFormatFromContext(context) {
  ...
  Object.keys(context.format).forEach(function (name) {
    if (_this3.quill.scroll.query(name, _parchment2.default.Scope.INLINE) == null) {
      return;
    }
...
function handleEnter(range, context) {
  ...
  var lineFormats = Object.keys(context.format).reduce(function (lineFormats, format) {
    if (_this4.quill.scroll.query(format, _parchment2.default.Scope.BLOCK) && !Array.isArray(context.format[format])) {
  ...
  Object.keys(context.format).forEach(function (name) {
    ...
    if (name === 'link') return;
    _this4.quill.format(name, context.format[name], _quill2.default.sources.USER);
  });
}
...
exports.applyFormat = exports.matchText = exports.matchSpacing = exports.matchNewline = exports.matchBlot = exports.matchAttributor = exports.default = undefined;
...
var CLIPBOARD_CONFIG = [[Node.TEXT_NODE, matchText], [Node.TEXT_NODE, matchNewline], ['br', matchBreak], [Node.ELEMENT_NODE, matchNewline], [Node.ELEMENT_NODE, matchBlot], [Node.ELEMENT_NODE, matchSpacing], [Node.ELEMENT_NODE, matchAttributor], [Node.ELEMENT_NODE, matchStyles], ['li', matchIndent], ['b', matchAlias.bind(matchAlias, 'bold')], ['i', matchAlias.bind(matchAlias, 'italic')], ['style', matchIgnore], [_header.headersSelector, _header.matchHeaders]];
...
var Clipboard = function (_Module) {
  ...
  _createClass(Clipboard, [{
    ...
    value: function convert(html) {
      ...
      var delta = traverse(this.quill.scroll, this.container, elementMatchers, textMatchers);
    ...
    value: function shouldAddNewlineBeforePaste(pasteDelta, index) {
      if (pasteDelta.ops.length == 0 || pasteDelta.ops[0].attributes == null || pasteDelta.ops[0].attributes[_list2.default.blotName] == null) {
        return false;
      }
      if (index == 0) {
        return false;
      }
      var previousChar = this.quill.getText(index - 1, 1);
...
function traverse(scroll, node, elementMatchers, textMatchers) {
  // Post-order
  if (node.nodeType === node.TEXT_NODE) {
    ...
    return [].reduce.call(node.childNodes || [], function (delta, childNode) {
      var childrenDelta = traverse(scroll, childNode, elementMatchers, textMatchers);
...
function matchAttributor(node, delta, scroll) {
  ...
  attributes.concat(classes).concat(styles).forEach(function (name) {
    var attr = scroll.query(name, _parchment2.default.Scope.ATTRIBUTE);
    if (attr != null) {
...
function matchBlot(node, delta, scroll) {
  ...
  if (match.prototype instanceof _parchment2.default.Embed) {
    ...
    if (value != null) {
      ...
      delta = new _quillDelta2.default().insert(embed, match.formats(node, scroll));
    }
...
exports.ColorStyle = exports.ColorAttributor = undefined;
...
var _clipboard = __webpack_require__(29);
...
var keysShim = origKeys ? function keys(o) { return origKeys(o); } : __webpack_require__(56);
...
var supportsDescriptors = __webpack_require__(19).supportsDescriptors;
var $gOPD = Object.getOwnPropertyDescriptor;
var $TypeError = TypeError;
...
exports.BackgroundStyle = undefined;
...
var List = function (_Container) {
  ...
  function List(scroll, domNode) {
    _classCallCheck(this, List);

    var _this2 = _possibleConstructorReturn(this, (List.__proto__ || Object.getPrototypeOf(List)).call(this, scroll, domNode));

    var listEventHandler = function listEventHandler(e) {
      if (e.target.parentNode !== domNode) return;
      var format = _this2.statics.formats(domNode);
      var blot = scroll.find(e.target);
      if (format === 'checked') {
  ...
  _createClass(List, [{
    ...
    value: function replace(target) {
      if (target.statics.blotName !== this.statics.blotName) {
        var item = this.scroll.create(this.statics.defaultChild);
...
module.exports = {
  'align': {
    ...
    'center': __webpack_require__(96),
    'right': __webpack_require__(97),
    'justify': __webpack_require__(98)
  },
  'background': __webpack_require__(99),
  'blockquote': __webpack_require__(100),
  'bold': __webpack_require__(101),
  'clean': __webpack_require__(102),
  ...
  'italic': __webpack_require__(113),
  ...
  'list': {
    'ordered': __webpack_require__(118),
    'bullet': __webpack_require__(119),
    'check': __webpack_require__(120)
  },
  'script': {
    'sub': __webpack_require__(121),
    'super': __webpack_require__(122)
  },
  'strike': __webpack_require__(123),
  'underline': __webpack_require__(124),
  'video': __webpack_require__(125)
};
...
function endsWithNewlineChange(scroll, delta) {
  ...
  if (lastOp.attributes != null) {
    return Object.keys(lastOp.attributes).some(function (attr) {
      return scroll.query(attr, _parchment2.default.Scope.BLOCK) != null;
    });
  }
  return false;
}
...
var GetIntrinsic = __webpack_require__(64);
...
exports.headersSelector = exports.matchHeaders = undefined;

var _bold = __webpack_require__(34);
...
var headersTagNames = ['H1', 'H2', 'H3', 'H4', 'H5', 'H6'];
var headersSelector = headersTagNames.join(", ");

function matchHeaders(node, delta) {
    var format = {};
    format[_bold2.default.blotName] = true;

    var fontSize = getComputedStyle(node).fontSize;
    if (fontSize) {
        format.size = fontSize;
    }
    delta = (0, _clipboard.applyFormat)(delta, format);
    return delta;
}

exports.matchHeaders = matchHeaders;
exports.headersSelector = headersSelector;
  ...
  _createClass(Toolbar, [{
    ...
    value: function attach(input) {
      ...
      input.addEventListener(eventName, function (e) {
        ...
        } else if (_this2.quill.scroll.query(format).prototype instanceof _parchment2.default.Embed) {
...
var _underline = __webpack_require__(90);
...
var _formula = __webpack_require__(93);

var _formula2 = _interopRequireDefault(_formula);

var _syntax = __webpack_require__(94);
...
var _bubble = __webpack_require__(127);
...
_core2.default.register({
  ...
  'functions/applyFormatToDelta': _clipboard.applyFormat
...
var Image = function (_Parchment$Embed) {
  ...
  _createClass(Image, [{
    ...
    key: 'formats',
    value: function formats(domNode) {
      var attributes = ATTRIBUTES.reduce(function (formats, attribute) {
        if (domNode.hasAttribute(attribute)) {
          formats[attribute] = domNode.getAttribute(attribute);
        }
        return formats;
      }, {});
      var styles = STYLES.reduce(function (formats, style) {
...
function initialize(klass, html) {
  ...
  var scroll = new _scroll2.default(_quill.globalRegistry, container, { emitter: emitter });
...
describe('Scroll', function () {
  ...
  describe('leaf()', function () {
    ...
    it('cursor', function () {
      ...
      var htmlBeforeFormat = selection.scroll.innerHtml;
...
describe('Block', function () {
  ...
  it('join empty lines', function () {
    var scroll = this.initialize(_scroll2.default, '<p><br></p><p><br></p>');
    scroll.deleteAt(1, 1);
    expect(scroll.domNode).toEqualHTML('<p><br></p>');
  });
  ...
  it('format newline', function () {
    var scroll = this.initialize(_scroll2.default, '<p>Hello</p>');
...
describe('Editor', function () {
  ...
  describe('applyDelta', function () {
    ...
    it('unformatted newline', function () {
      var editor = this.initialize(_editor2.default, '<blockquote>01</blockquote>');
  ...
  describe('getFormat()', function () {
    ...
    it('formatted', function () {
      var editor = this.initialize(_editor2.default, '<blockquote><em>0123</em></blockquote>');
      expect(editor.getFormat(1)).toEqual({ blockquote: true, italic: true });
    });

    it('cursor', function () {
      var editor = this.initialize(_editor2.default, '<blockquote><strong><em>0123</em></strong></blockquote>p><u>5678</u></p>');
...
describe('Quill', function () {
  ...
  describe('format', function () {
    beforeEach(function () {
      ...
      this.setup = function (html, index) {
        _this.quill = _this.initialize(_quill2.default, html);
        _this.quill.setSelection(index);
      };
      this.insertText = function (text) {
        document.execCommand('insertText', false, text);
        _this.quill.scroll.update();
      };
    });
  ...
  describe('api', function () {
    ...
    it('formatLine()', function () {
      ...
      var change = new _quillDelta2.default().retain(8).retain(1, { blockquote: true });
  ...
  describe('events', function () {
    ...
    it('user text insert', function (done) {
      ...
      var delta = new _quillDelta2.default().retain(2).insert('!');
      setTimeout(function () {
        expect(_this2.quill.emitter.emit).toHaveBeenCalledWith(_emitter2.default.events.TEXT_CHANGE, delta, _this2.oldDelta, _emitter2.default.sources.USER);
        done();
      }, 1);
    });
    ...
    it('insert same character', function (done) {
      ...
      setTimeout(function () {
        var args = _this3.quill.emitter.emit.calls.mostRecent().args;
...
describe('Link', function () {
  ...
  it('remove', function () {
    var editor = this.initialize(_editor2.default, '<p>0<a style="font-size: 26px" href="https://quilljs.com" target="_blank">12</a>3</p>');
    editor.formatText(1, 2, { link: false });
    var delta = new _quillDelta2.default().insert('0').insert('12', { size: '26px' }).insert('3\n');
    expect(editor.getDelta()).toEqual(delta);
...
describe('Code', function () {
  ...
  it('delete merge before', function () {
    var editor = this.initialize(_editor2.default, { html: '<blockquote>0123</blockquote><pre>4567\n</pre>' });
    editor.deleteText(4, 1);
  ...
  it('delete across after', function () {
    var editor = this.initialize(_editor2.default, { html: '<blockquote>0123</blockquote><pre>56\n89\n</pre>' });
  ...
  it('replace multiple', function () {
    ...
    expect(editor.getDelta()).toEqual(new _quillDelta2.default().insert('01').insert('\n', { blockquote: true }).insert('23').insert('\n', { blockquote: true }));
  ...
  it('format interior line', function () {
    ...
    expect(editor.getDelta()).toEqual(new _quillDelta2.default().insert('01').insert('\n', { 'code-block': true }).insert('23').insert('\n', { 'blockquote': true }).insert('45').insert('\n', { 'code-block': true }));
...
describe('Header', function () {
  it('parse', function () {
    var expectedDelta = new _quillDelta2.default().insert('Test', { size: '26px', bold: true }).insert('\n\n');
  ...
  it('parse with font', function () {
    var expectedDelta = new _quillDelta2.default().insert('Test', { size: '8px', bold: true }).insert('\n\n');
    var quill = this.initialize(_core2.default, '');
...
describe('Image', function () {
  it('plain', function () {
    var editor = this.initialize(_editor2.default, '<img src="somewhere.png">');
    expect(editor.getDelta()).toEqual(new _quillDelta2.default().insert({ image: "somewhere.png" }).insert('\n'));
  });
  it('with size in attributes', function () {
    var editor = this.initialize(_editor2.default, '<img src="somewhere.png" width="100px" height="200px">');
    expect(editor.getDelta()).toEqual(new _quillDelta2.default().insert({ image: "somewhere.png" }, { width: "100px", height: "200px" }).insert('\n'));
  });
  it('with size in styles', function () {
    var editor = this.initialize(_editor2.default, '<img src="somewhere.png" style="width:100px; height:200px">');
    expect(editor.getDelta()).toEqual(new _quillDelta2.default().insert({ image: "somewhere.png" }, { width: "100px", height: "200px" }).insert('\n'));
  });
  it('with size in styles and attributes', function () {
    var editor = this.initialize(_editor2.default, '<img src="somewhere.png" width="400px" height="300px" style="width:100px; height:200px">');
    expect(editor.getDelta()).toEqual(new _quillDelta2.default().insert({ image: "somewhere.png" }, { width: "100px", height: "200px" }).insert('\n'));
  });
  it('set size', function () {
    var editor = this.initialize(_editor2.default, '<img src="somewhere.png" width="400px" height="300px" style="width:100px; height:200px">');
    editor.formatText(0, 1, { width: "700px", height: "900px" });
    expect(editor.getDelta()).toEqual(new _quillDelta2.default().insert({ image: "somewhere.png" }, { width: "700px", height: "900px" }).insert('\n'));
  });
});
...
describe('Clipboard', function () {
  describe('events', function () {
    beforeEach(function () {
      this.quill = this.initialize(_core2.default, '<p>0123</p><p>5<em>67</em>8</p>');
    ...
    it('paste after link', function (done) {
      ...
      var originalDelta = new _quillDelta2.default().insert('Link', { link: 'http://amsterdam.nl', color: '#112233', underline: true, size: '26px' });
      var expectedDelta = new _quillDelta2.default().insert('Link', { link: 'http://amsterdam.nl', color: '#112233', underline: true, size: '26px' }).insert('Text\n');
...
describe('History', function () {
  describe('getLastChangeIndex', function () {
    it('delete', function () {
      ...
      expect((0, _history.getLastChangeIndex)(_quill.globalRegistry, delta)).toEqual(4);
    });

    it('delete with inserts', function () {
      var delta = new _quillDelta2.default().retain(4).insert('test').delete(2);
      expect((0, _history.getLastChangeIndex)(_quill.globalRegistry, delta)).toEqual(8);
    });

    it('insert text', function () {
      var delta = new _quillDelta2.default().retain(4).insert('testing');
      expect((0, _history.getLastChangeIndex)(_quill.globalRegistry, delta)).toEqual(11);
    });

    it('insert embed', function () {
      var delta = new _quillDelta2.default().retain(4).insert({ image: true });
      expect((0, _history.getLastChangeIndex)(_quill.globalRegistry, delta)).toEqual(5);
    });
    ...
    it('format', function () {
      ...
      expect((0, _history.getLastChangeIndex)(_quill.globalRegistry, delta)).toEqual(7);
    });
...
describe('Keyboard', function () {
  describe('match', function () {
    ...
    it("Don't autostart after manual list", function () {
      var originalDelta = new _quillDelta2.default().insert('- Test\n-');
      var expectedDeltaAfterInput = new _quillDelta2.default().insert('- Test\n-\n');
  ...
  describe('active', function () {
    beforeEach(function () {
      ...
      this.quill = new _quill2.default(container, {
        modules: {
          toolbar: [['bold', 'link'], [{ 'size': ['12px', false, '26px'] }], [{ 'align': '' }, { 'align': 'center' }]]
        },
        theme: 'snow'
      });
    });
